...
def analyze_image(image):
    # ⚠️ ใช้ชื่อนี้เป๊ะๆ ครับ "gemini-1.5-flash" 
    # (รุ่นนี้ให้ฟรี 1,500 ครั้ง/วัน ไม่ใช่ 20 ครั้งเหมือนรุ่น 2.5)
    ...
    try:
        ...
        # แสดงชื่อโมเดลที่ Error ออกมาด้วย จะได้รู้ว่าแอพใช้ตัวไหนอยู่
        return {"pot_number": "", "species": f"Error ({model_name}): {e}", "thai_name": "เช็คชื่อโมเดลอีกครั้ง"}
